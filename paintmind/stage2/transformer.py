...
from ..modules.attention import CrossAttention, MemoryEfficientCrossAttention
...
class Layer(nn.Module):
    ...
    def __init__(self, dim, dim_head, mlp_dim, num_head=8, dropout=0.0, dim_context=None):
        ...
        self.attn2 = attn_cls(
            query_dim=dim, context_dim=dim_context, heads=num_head, dim_head=dim_head, dropout=dropout
        )
